...
In this occasion, the system doesn't have any specified behavior for these circumstances, and is neither expressed in the tests. In other cases, the bug is some kind of error not covered by the current tests.
